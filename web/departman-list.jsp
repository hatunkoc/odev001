...
<li><a href="<%=request.getContextPath()%>/izinListele" class="nav-link">İzinlerim</a></li>
	...
	<div class="row">
		...
		<div class="container">
			<h3 class="text-center">Departman Listesi</h3>
			<hr>
			<div class="container text-left">

				<a href="<%=request.getContextPath()%>/yeniDepartman" class="btn btn-success">Yeni Departman Ekle</a>
			</div>
			<br>
				...
				<tbody>
					...
					<c:forEach var="departman" items="${listDepartman}">
						...
						<tr>
							...
							<td><c:out value="${departman.ad}" /></td>
							<td><a href="departmanDuzenle?id=<c:out value='${departman.id}' />">Edit</a>
								&nbsp;&nbsp;&nbsp;&nbsp; <a
								href="departmanSil?id=<c:out value='${departman.id}' />">Delete</a></td>
						</tr>
					</c:forEach>
					<!-- } -->
				</tbody>
